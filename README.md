...
4. O programa "auto_regi" precisa de uma série de arquivos chamados de tabelas basicas para funcionar. Também precisa do arquivo "nindinet.dbf". Esses arquivos são gerados pelo programa SINAN NET.  
